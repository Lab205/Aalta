...
${OBJECTDIR}/src/ltlparser/ltl_formula.o: src/ltlparser/ltl_formula.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ltlparser/ltl_formula.o src/ltlparser/ltl_formula.c

${OBJECTDIR}/src/ltlparser/ltllexer.o: src/ltlparser/ltllexer.c 
	${MKDIR} -p ${OBJECTDIR}/src/ltlparser
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ltlparser/ltllexer.o src/ltlparser/ltllexer.c

${OBJECTDIR}/src/ltlparser/ltlparser.o: src/ltlparser/ltlparser.c 
	${MKDIR} -p ${OBJECTDIR}/src/ltlparser
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ltlparser/ltlparser.o src/ltlparser/ltlparser.c

${OBJECTDIR}/src/ltlparser/trans.o: src/ltlparser/trans.c 
	${MKDIR} -p ${OBJECTDIR}/src/ltlparser
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ltlparser/trans.o src/ltlparser/trans.c
...
${TESTDIR}/tests/ltlparser_test.o: tests/ltlparser_test.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ltlparser_test.o tests/ltlparser_test.cpp
...
${OBJECTDIR}/src/ltlparser/ltl_formula_nomain.o: ${OBJECTDIR}/src/ltlparser/ltl_formula.o src/ltlparser/ltl_formula.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ltlparser/ltl_formula_nomain.o src/ltlparser/ltl_formula.c;\
	else  \
...
${OBJECTDIR}/src/ltlparser/ltllexer_nomain.o: ${OBJECTDIR}/src/ltlparser/ltllexer.o src/ltlparser/ltllexer.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ltlparser/ltllexer_nomain.o src/ltlparser/ltllexer.c;\
	else  \
...
${OBJECTDIR}/src/ltlparser/ltlparser_nomain.o: ${OBJECTDIR}/src/ltlparser/ltlparser.o src/ltlparser/ltlparser.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ltlparser/ltlparser_nomain.o src/ltlparser/ltlparser.c;\
	else  \
...
${OBJECTDIR}/src/ltlparser/trans_nomain.o: ${OBJECTDIR}/src/ltlparser/trans.o src/ltlparser/trans.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ltlparser/trans_nomain.o src/ltlparser/trans.c;\
	else  \
